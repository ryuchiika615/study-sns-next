...
export default function LanguageSetting() {
  ...
  return <div>
    <p className="text-sm font-bold text-gray-800">{isEnglish ? "Display language" : "表示言語"}</p>
    <p className="mt-1 text-xs text-gray-500">{isEnglish ? "Menus, buttons, and guidance are displayed in Japanese or English. Post text can be opened in Google Translate at no extra cost." : "画面のメニュー・ボタン・案内文を日本語または英語で表示します。投稿本文は無料でGoogle翻訳を開けます。"}</p>
