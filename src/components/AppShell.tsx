...
export default function AppShell({ children, unreadCount = 0 }: { children: React.ReactNode; unreadCount?: number }) {
  return (
    <>
      <div className="lytter-home-banner bg-gradient-to-b from-gray-900 to-blue-900 border-b-3 border-yellow-600 text-center py-4 shadow-lg mb-4">
        <Sidebar />
        <h1 className="text-3xl text-yellow-600 font-serif tracking-wider m-0" style={{ textShadow: "0 2px 4px rgba(0,0,0,0.5)" }}>
          LYTTER HOME
        </h1>
        <p className="text-sm text-yellow-600 tracking-widest mt-1">リュッター ホーム</p>
      </div>
