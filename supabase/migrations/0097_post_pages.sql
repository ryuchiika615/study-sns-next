-- Add page tracking columns to posts
ALTER TABLE posts ADD COLUMN IF NOT EXISTS pages_completed integer DEFAULT 0;
ALTER TABLE posts ADD COLUMN IF NOT EXISTS total_pages integer DEFAULT 0;

-- Update create_post RPC to accept page data
...
BEGIN
  ...
  INSERT INTO public.posts (user_id, content, subject, study_minutes, image_url, image_urls, quote_post_id, quote_comment_id, is_silent, audio_url, audio_name, created_at, workout_minutes, pages_completed, total_pages)
  VALUES (v_user_id, p_content, p_subject, p_study_minutes, p_image_url, p_image_urls, p_quote_post_id, p_quote_comment_id, p_silent, p_audio_url, p_audio_name, v_created_at, p_workout_minutes, p_pages_completed, p_total_pages)
